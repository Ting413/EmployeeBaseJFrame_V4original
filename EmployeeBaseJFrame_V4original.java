package Ting.payablesys.employeetype.frame;
...
import Ting.payablesys.employee.buttoncontroller.ButtonController4SuperBase;
import Ting.payablesys.employeetype.earningbook.EmployeeBaseBook;
import Ting.payablesys.employee.helper.Helper4SuperEmployeeBase;
import Ting.payablesys.employee.helper.Verifier4SuperEmployeeBase;

//import com.sun.xml.internal.ws.api.Component;

import Ting.polymorphism.emplyee.menuoption.EmployeeRecordIndices;
import wu.library.filestream.*;
import wu.library.checkandvalidation.*;
import wu.library.menuoption.*;
...
public class EmployeeBaseJFrame_V4 extends /* JInternalFrame */ JFrame {

	public static final long serialVersionUID = 1L;
	// public static Component frame;
	// public JPanel contentPane;
	public static EmployeeBaseJFrame_V4 frame;
   ...
   public JTextField txtFieldLowestE;
	...
	public String title4InputArea = "Main Frame Area", tip4InputArea = "Input and Calculate";
	...
	public String title4JTable = "Record Output Table", tip4JTable = "Ourput Records to Table";
	...
	public DefaultListModel<Object> listModel = new DefaultListModel<Object>(); // need to figure out later
																				// (DefaultListModel)
...
//		employeeType = "SuperBase Emplyee (by LiTing 2023/12/13)";
//		EmployeeBaseJFrame_V4 frame_real = new EmployeeBaseJFrame_V4(employeeType);
...
//			public void run() {
//				try {
//					EmployeeBaseJFrame_V4 frame = new EmployeeBaseJFrame_V4(employeeType);
...
//		});
	 ...
	 * Create the frame.
	 */
	public EmployeeBaseJFrame_V4(String employeeType) {
//		super(employeeType + "-App"); //either with or without this line is OK(for JFrame)
...
//				true); //iconifiable
		...
		employeeType4Jframe = employeeType /* "SuperBase Emplyee" */;
		setupAll();

//		setTitle("Employee-Book Application (by LiTing 2023/11/08)");
//		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
//		setBounds(-60, -37, 722, 662);
...
//		setupComponents4JPanel();
	 ...
	 */
	public EmployeeBaseJFrame_V4(String employeeType, JDesktopPane _theDesktop) {
		employeeType4Jframe = "SuperBase Emplyee";
		setupAll();
	...
	public void setupAll() {
		...
		initializeTitleNameList4JTable();
		initialize4TitleNamesString4JTable();
		
//		setupMenubarWithLookAndFeel(300, 0, 115, 35);
//		menuBar.setBounds(300, 0, 115, 35);
//		setupMenubarWithLookAndFeel(300, 0, 115, 35, EmployeeBaseJFrame_V4.class, null);

//		setupMenubarWithLookAndFeel(300, 0, 115, 35, this, EmployeeBaseJFrame_V4.this);
		setupMenubarWithLookAndFeel(300, 0, 115, 35, EmployeeBaseJFrame_V4.class, this);
...
//		verifier4Employee = new Verifier4SuperEmployeeBase(this);
	...
	public static void Main_Run(EmployeeBaseJFrame_V4 component, String _employeeType,
...
//		component.pluginVerifier4TextFieldArrayList();
	...
	public static void setTheLookAndFellInMain(/* Component resourceBase */ EmployeeBaseJFrame_V4 _frame) {
//  public static void setTheLookAndFellInMain(/*Component component){
	...
	public static void run2StartOrRefresh(String _frameTitle, EmployeeBaseJFrame_V4 component) {

		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					// Set the look and feel.
					setTheLookAndFellInMain(component);
	...
	protected void setUpTitleAndBasics4JFrame(String __frameTitle, String employeeType) {
		setTitle(__frameTitle + employeeType);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
...
//		txtArea4RecordTextArea.setLineWrap(true);//with this line on --> no horizontal JScrollPane
		...
		setSize(712, 750);
		setVisible(true);
	} // end createAndSetupCoreComponents4JTabbedPane()
...
//			optionButtons[i].setIcon(new ImageIcon(EmployeeBaseJFrame_V4.class.getResource(basicChoices[i].getImageIcon())));
...
//			contentPane.add(txtField);
	...
	}// end initializeTextFileArrayList()
...
//	}
	...
	protected void initializeTitleNameList4JTable() {
		String[] titleNames4Table = { EmployeeRecordIndices.SSN.getRecordIndexType(),
...
//    		Component component) {
		...
		itemCustom.setForeground(new Color(0, 0, 0));
...
//				try { initLookAndFeel();}
				...
				SwingUtilities.updateComponentTreeUI(EmployeeBaseJFrame_V4.this);
			}
		});

		buttonGroup.add(itemCustom);
		mnLookFeel.add(itemCustom);
		// ----------End Design ButtonGroup for LookAndFell----------
		menuBar.add(mnLookFeel);
	} //end setupMenubarWithLookAndFeel()

	public void addJTable2Box() {
		box3.add(tableAggregate);
	}

	public EmployeeBaseBook setBasics2StarBookingEmployee() {
		employeeBook = new EmployeeBaseBook(helper4Employee.CompanyName, helper4Employee.EmployeeNo, true);
		btnOpenFile.setEnabled(true); //added on 23Decc17
		btnCalculate.setEnabled(false); //old one
		return employeeBook;
	}

	public EmployeeBaseJFrame_V4 refreshJframe() {
		EmployeeBaseJFrame_V4 component = new EmployeeBaseJFrame_V4(employeeType4Jframe);
		buttonController = new ButtonController4SuperBase(new EmployeeBaseJFrame_V4(employeeType4Jframe), theDesktop);
